  ...
  return (
    <div className="app">
      ...
      <a
        ...
        className="fixed flex items-center justify-center w-auto h-auto p-1 text-white rounded-full large:right-8 bg-discountGreen hover:bg-white hover:border hover:text-discountGreen hover:border-discountGreen large:bottom-5 small:bottom-6 small:right-5 small:z-10"
      >
