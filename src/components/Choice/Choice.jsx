...
function Choice() {
  return (
    <div className="lg:flex-row lg:border lg:pt-5 lg:gap-3 lg:justify-around lg:items-start lg:flex lg:h-100vh lg:w-100vw choice sm:flex sm:flex-col sm:w-90vw sm:items-center sm:h-auto sm:gap-3">
      <div className="h-auto lg:w-40 lg:rounded-10 sm:w-100">
        <iframe
          //   width="100%"
          //   height="315"
          className="lg:h-315px lg:w-100 rounded-20 sm:h-200px sm:w-100"
      ...
      <div className="lg:gap-2 lg:h-auto lg:flex-col lg:flex lg:w-50 sm:w-100 sm:px-1 sm:h-auto sm:gap-3 sm:flex sm:flex-col sm:pb-3">
        <h1 className="lg:text-30px text-vogueWhite sm:text-15px">
...
function Independence() {
    return (
      <div className="flex items-start justify-center pt-3 border h-100vh w-100vw independence sm:flex sm:flex-col sm:w-90vw sm:h-auto sm:items-center">
        <div className="flex flex-col justify-center h-auto gap-1 w-30 rounded-10 sm:w-100">
            <Link
            to="/choice"
            ...
            <img src={PHOTOS.independence} alt=""  className="h-430px w-90 sm:w-100"/>
        </div>
  
        <div className="flex flex-col w-40 h-auto gap-2 pt-3 sm:w-100 sm:items-center sm:pb-3">
          <h1 className="text-black text-30px">
            Grab <span className="font-bold">20% OFF</span>
            Instantly
          </h1>
  
          <p className="text-black text-15px sm:text-center">
          ...
          <div className="flex flex-col w-auto h-auto gap-1 sm:items-center">
