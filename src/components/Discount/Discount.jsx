...
function Discount() {
  return (
    <div className="flex flex-col items-center h-auto gap-3 mt-2 large:w-60vw small:w-90vw discount">
      ...
      <p className="large:text-15px small:text-13px small:mt-4 large:mt-0"><span className="font-bold">Location:</span> 167 Iju Road, Beside Providence Schools, Fagba, Lagos, Nigeria.</p>
    </div>
  );
}
